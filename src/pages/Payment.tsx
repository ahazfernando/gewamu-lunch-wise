...
const Payment = () => {
  ...
  // Mock order data - amounts converted to LKR (320 LKR = 1 USD)
  const orderData = {
    id: orderId || "1",
    restaurant: "Sakura Sushi",
    organizer: "John Doe",
    amount: 7760, // 24.25 USD * 320 LKR/USD
        ...
        <Card className="w-full max-w-md">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-muted-foreground mb-4">
              Your payment of LKR {orderData.amount.toLocaleString()} has been processed successfully.
            </p>
            <div className="space-y-2 text-sm text-muted-foreground">
              <div>Restaurant: {orderData.restaurant}</div>
              <div>Organizer: {orderData.organizer}</div>
              <div>Amount: LKR {orderData.amount.toLocaleString()}</div>
            </div>
            <Button 
                ...
                {paymentMethod === 'cash' && (
                  <div className="text-center py-8">
                    ...
                    <p className="text-sm text-muted-foreground mb-4">
                      Hand over LKR {orderData.amount.toLocaleString()} to {orderData.organizer} directly
                    </p>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="border-t pt-4">
                <div className="flex justify-between text-lg font-semibold">
                  ...
                  <span className="text-primary">LKR {orderData.amount.toLocaleString()}</span>
                </div>
              </div>
              ...
              >
                ...
                {paymentMethod === 'cash' ? 'Confirm Cash Payment' : `Pay LKR ${orderData.amount.toLocaleString()}`}
              </Button>
